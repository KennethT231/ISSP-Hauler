...
export default function OfferInfo({ response, setOffer, onSendOffer, offer, onAccept, onDecline, jobStatus }) {
            ...
            <View style={styles.footerContainer}>
                ...
                <View style={styles.buttonContainer}>
                    {onAccept ?
                        <>
                            <TouchableOpacity
                                disabled={jobStatus !== 'Available' || jobStatus !== 'Negotiating'}
                                style={ jobStatus !== 'Available' || jobStatus !== 'Negotiating' ? [styles.button, styles.disabledButton] :[styles.button, styles.acceptButton]}
                                onPress={() => onAccept()}>
                                <Text style={styles.buttonTitle}>ACCEPT</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                disabled={jobStatus !== 'Available' || jobStatus !== 'Negotiating'}
                                style={ jobStatus !== 'Available' || jobStatus !== 'Negotiating' ? [styles.button, styles.disabledButton] :[styles.button, styles.declineButton]}
                                onPress={() => onDecline()}>
