...
export default function Confirmation({ navigation, route }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Post A Job', { screen: 'AddItemScreen' })} style={styles.button}><Text style={styles.btnText}>Return To Posting a Job </Text></TouchableOpacity>
